...
// Descrição   : Este programa apresenta os conceitos bsicos sobre entrada, processamento e saida de dados.
// Autor(a)    : Daniel Luiz Coelho dos Santos
// Data atual  : 23/03/2025
// Algoritmo   : EntradaProcessamentoESaidaDeDados

programa
{
	funcao inicio()
	{
		// Declaraço de variãveis
		cadeia nome = ""
		cadeia sobreNome = ""
		cadeia nomeCompleto = ""
